import { ArrowRight, Github, Linkedin, Mail, Palette, Code, Users } from "lucide-react"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 flex items-center min-h-screen lg:min-h-[80vh]">
          <div className="max-w-2xl">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary mb-6">
              Hello, my name is <span className="text-[var(--vibrant)]">Luiz</span>
            </h1>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-primary mb-8">
              I am a Software Engineer
            </h2>
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              I specialize in building scalable web applications and mobile solutions that solve real-world problems. 
              With a passion for clean code, modern technologies, and exceptional user experiences, 
              I transform complex challenges into elegant, functional solutions.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            A comprehensive skill set combining technical expertise, design thinking, and collaborative leadership
          </p>
        </div>
